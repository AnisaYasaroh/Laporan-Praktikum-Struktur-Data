...
struct dataMahasiswa63 {
    string nama;
    string nim;
    dataMahasiswa63* next;
};

class LinkedList {
private:
    dataMahasiswa63* head;
...
public:
    ...
    void addFirst(string nama, string nim) {
        dataMahasiswa63* newNode = new dataMahasiswa63();
        newNode->nama = nama;
        newNode->nim = nim;
        newNode->next = head;
        head = newNode;
    ...
    void deleteMiddle(int posisi) {
        ...
        dataMahasiswa63* nextNode = temp->next->next;
        delete temp->next;
        temp->next = nextNode;
        cout << endl << "Data di posisi " << posisi << " telah dihapus."<< endl;
    }
